...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 28,fontWeight: FontWeight.bold,color: Colors.black),
    ...
    bodySmall:   const TextStyle().copyWith(fontSize: 16,fontWeight: FontWeight.w500,color: Colors.black.withOpacity(0.5)),
