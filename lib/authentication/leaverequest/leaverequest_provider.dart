...
import '../models/leaverequest/leaverequest_model.dart';


class LeaveRequestProvider with ChangeNotifier {
  bool _isLoading = false;
  LeaveModel _leaveModel = LeaveModel();
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.leaverequest);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _leaveModel = LeaveModel.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
