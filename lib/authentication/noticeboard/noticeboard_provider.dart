...
import 'package:school_management/authentication/models/noticeboard/noticebaord_model.dart';
...
class NoticeboardProvider with ChangeNotifier {
  ...
  NoticeboardModel _noticeModel = NoticeboardModel();

  bool get isLoading => _isLoading;
  NoticeboardModel get noticeModel => _noticeModel;
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.noticeboard);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _noticeModel = NoticeboardModel.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
