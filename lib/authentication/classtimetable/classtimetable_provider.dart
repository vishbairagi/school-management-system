...
import 'package:school_management/authentication/models/classtimetable/classtimetable_model.dart';
...
class ClasstimetableProvider with ChangeNotifier {
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.classtimetable);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _timetableModel = TimetableModel.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
