...
import '../models/studymaterial/studymaterial_model.dart';


class StudymaterialProvider with ChangeNotifier {
  bool _isLoading = false;
  StudyMaterialModel _studyMaterialModel = StudyMaterialModel();

  bool get isLoading => _isLoading;
  StudyMaterialModel get studyMaterialModel => _studyMaterialModel;
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.studymaterial);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _studyMaterialModel = StudyMaterialModel.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
