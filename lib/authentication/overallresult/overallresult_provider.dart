...
import '../models/overallresult/overallresult_model.dart';


class OverallresultProvider with ChangeNotifier {
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.overall_result);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _resultModel = ResultModel.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
