...
import 'package:school_management/authentication/models/Live/live_model.dart';
...
class LiveProvider with ChangeNotifier {
  ...
  LiveClassResponse _liveModel = LiveClassResponse();

  bool get isLoading => _isLoading;
  LiveClassResponse get liveModel => _liveModel;
  ...
  Future<void> home() async {
    ...
    var apiUrl = Uri.parse(ApiRoutes.livecalsses);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _liveModel = LiveClassResponse.fromJson(responseBody); // Map JSON to model
        _setLoading(false);
        notifyListeners();
      } else {
